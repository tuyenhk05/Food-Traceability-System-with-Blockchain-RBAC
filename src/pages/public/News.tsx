  ...
  const newsArticles: NewsArticle[] = [
    {
      ...
      excerpt:
        "Công nghệ blockchain đang mang lại sự minh bạch chưa từng có cho chuỗi cung ứng nông sản, giúp người tiêu dùng tin tưởng hơn vào nguồn gốc thực phẩm.",
      content: "",
      category: "Công nghệ",
      author: "Nguyễn Văn A",
      date: "20/06/2024",
    ...
    },
    {
      ...
      excerpt:
        "Người tiêu dùng Việt Nam ngày càng quan tâm đến thực phẩm hữu cơ, tạo cơ hội lớn cho nông dân chuyển đổi sang canh tác bền vững.",
      content: "",
      category: "Xu hướng",
      author: "Trần Thị B",
      date: "18/06/2024",
    ...
    },
    {
      ...
      excerpt:
        "Chúng tôi tự hào thông báo đã mở rộng mạng lưới đối tác lên 500 nông trại, cam kết mang đến sản phẩm chất lượng và minh bạch.",
      content: "",
    ...
    },
    {
      ...
      excerpt:
        "Chỉ với một lần quét mã QR, bạn có thể biết toàn bộ hành trình của sản phẩm từ nông trại đến tay người tiêu dùng.",
      content: "",
      category: "Hướng dẫn",
      author: "Lê Văn C",
      date: "12/06/2024",
    ...
    },
    {
      ...
      excerpt:
        "Câu chuyện thành công của các nông dân Đà Lạt khi tham gia hệ thống truy xuất nguồn gốc, giúp sản phẩm được định giá cao hơn.",
      content: "",
      category: "Câu chuyện",
      author: "Phạm Thị D",
      date: "10/06/2024",
    ...
    },
    {
      ...
      excerpt:
        "Công nghệ IoT và blockchain đang giúp giám sát chặt chẽ điều kiện bảo quản, vận chuyển để đảm bảo an toàn thực phẩm tối đa.",
      content: "",
      category: "Công nghệ",
      author: "Hoàng Văn E",
      date: "08/06/2024",
    ...
    },
    {
      ...
      excerpt:
        "Tìm hiểu về chứng nhận VietGAP và tại sao nó quan trọng trong việc nâng cao giá trị nông sản Việt Nam trên thị trường.",
      content: "",
      category: "Kiến thức",
      author: "Vũ Thị F",
      date: "05/06/2024",
    ...
    },
    {
      ...
      excerpt:
        "Người tiêu dùng Việt Nam ngày càng ưa chuộng mua thực phẩm online, đặc biệt là các sản phẩm có nguồn gốc rõ ràng.",
      content: "",
      category: "Xu hướng",
      author: "Đỗ Văn G",
      date: "03/06/2024",
    ...
    },
    {
      ...
      excerpt:
        "Chúng tôi vinh dự được vinh danh tại Lễ trao giải Startup Công nghệ Nông nghiệp 2024 cho những đóng góp trong lĩnh vực truy xuất nguồn gốc.",
      content: "",
      category: "Tin công ty",
      author: "FoodTrace Team",
      date: "01/06/2024",
