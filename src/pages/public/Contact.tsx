  ...
  const faqs = [
    {
      ...
      answer:
        "Bạn chỉ cần quét mã QR trên bao bì sản phẩm hoặc nhập mã lô hàng trên trang chủ để xem toàn bộ hành trình của sản phẩm.",
    },
    {
      question: "Tôi là nông dân, làm sao để tham gia FoodTrace?",
      answer:
        "Vui lòng liên hệ với chúng tôi qua email hoặc hotline. Đội ngũ của chúng tôi sẽ hướng dẫn bạn quy trình đăng ký và sử dụng hệ thống.",
    },
    {
      question: "Chi phí sử dụng dịch vụ như thế nào?",
      answer:
        "Chúng tôi có nhiều gói dịch vụ phù hợp với quy mô khác nhau. Vui lòng liên hệ để được tư vấn chi tiết.",
    },
    {
      question: "Dữ liệu trên blockchain có an toàn không?",
      answer:
        "Hoàn toàn an toàn. Blockchain đảm bảo dữ liệu không thể bị thay đổi hoặc xóa, mang lại tính minh bạch và tin cậy tuyệt đối.",
    },
  ];
  return (
